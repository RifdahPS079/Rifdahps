<!-- Rifdah Pritama Saputri = Membuat resep_saya.php -->
<?php
// Koneksi ke database
...
<head>
    ...
    <title>Daftar Resep Saya - Recipe Website</title>
</head>
<body>
<header>
    <div class="container"> 
        ...
        <tbody>
            ...
            while($data = mysqli_fetch_array($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_resepkw.php?id=<?php echo $data['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i>&#x270E;</a>
...
<div class="container mt-4">
    <a href="profil.php" class="btn btn-primary">Kembali ke Daftar Profil</a>
</div>
